        ...
        <div class="container clearfix">
            ...
            <div class="row col-mb-50">
                <div class="col-lg-7">
                    ...
                    <div class="divider divider-sm"><i class="icon-star3"></i></div>
                </div>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="form-widget">
                        ...
                        <form action="include/form.php" id="template-jobform" name="template-jobform" class="row mb-0" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-12 form-group">
                                <button class="button button-3d button-large btn-block m-0" name="template-jobform-apply" type="submit" value="apply">Send Application</button>
                            </div>
