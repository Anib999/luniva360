			...
			<div class="row col-mb-30">
				...
				<div class="col-md-6 text-center text-md-right">
					<div class="d-flex justify-content-center justify-content-md-end">
						<a href="https://www.facebook.com/Luniva360/" target="_blank" class="social-icon si-small si-borderless si-facebook">
							<i class="icon-facebook"></i>
							<i class="icon-facebook"></i>
						</a>

						<a href="https://twitter.com/lunivatech" target="_blank" class="social-icon si-small si-borderless si-twitter">
							<i class="icon-twitter"></i>
							<i class="icon-twitter"></i>
						</a>

						<a href="https://www.linkedin.com/company/lunivatech-pvt-ltd-" target="_blank" class="social-icon si-small si-borderless si-linkedin">
					...
					<i class="icon-envelope2"></i> lunivatech.nepal@gmail.com <span class="middot">&middot;</span>
