					...
					<div class="header-row">
						...
						<div id="logo">
							<a href="index.html" class="standard-logo"
								data-dark-logo="images/luniva/lunivalogo.png"><img src="images/luniva/lunivalogo.png"
									alt="Canvas Logo"></a>
							<a href="index.html" class="retina-logo" data-dark-logo="images/luniva/lunivalogo.png"><img
							...
							<ul class="menu-container">
								...
								<li class="menu-item">
									...
									<ul class="sub-menu-container">
										<li class="menu-item">
											<a class="menu-link" href="product-lab.html">
												<div><i class="icon-stack"></i>Lunivacare Lab</div>
											</a>
										</li>
										<li class="menu-item">
											<a class="menu-link" href="product-telmed.html">
												<div><i class="icon-wpforms"></i>Lunivacare Telmed</div>
											</a>
										</li>
										<li class="menu-item">
											<a class="menu-link" href="product-mhealth.html">
												<div><i class="icon-wpforms"></i>Lunivacare Mhealth</div>
											</a>
										</li>
										<li class="menu-item">
											<a class="menu-link" href="product-clinic.html">
												<div><i class="icon-wpforms"></i>Lunivacare Clinic</div>
											</a>
										</li>
									</ul>
								</li>
				...
				<div class="swiper-container swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption slider-caption-center">
									...
									<p class="d-none d-sm-block" data-animate="fadeInUp" data-delay="200">Digital
										healthcare</p>
								</div>
							</div>
							<div class="swiper-slide-bg"
								style="background-image: url('images/luniva/1slide.jpg'); background-position: center top;">
							</div>
						</div>
						<div class="swiper-slide dark">
							<div class="container">
							...
							<div class="swiper-slide-bg"
								style="background-image: url('images/luniva/mask.jpg'); background-position: center top;">
							</div>
						...
						<div class="swiper-slide">
							...
							<div class="swiper-slide-bg"
								style="background-image: url('images/luniva/labtest.jpg'); background-position: center top;">
							</div>
						</div>
					</div>
			...
			<div class="content-wrap">
					...
					<div class="row align-items-center">
						...
						<div class="col-lg-7 align-self-end">
							...
							<div class="position-relative overflow-hidden">
								<img src="images/luniva/luniva360.jpg" data-animate="fadeInUp" data-delay="50"
									alt="Chrome">
								<!-- <img src="images/luniva/ipmobdas.png"
									style="top: 0; left: 0; min-width: 100%; min-height: 100%;" data-animate="fadeInUp"
									data-delay="400" alt="phone" class="position-absolute"> -->
							</div>
					...
					<div class="container">
						...
						<div class="row mt-4 col-mb-50 text-center">
							...
							<div class="col-lg-4">
								...
								<p class="text-left">Employment respond committed meaningful fight against oppression
									social challenges
							...
							<div class="col-lg-4">
								<i class="i-plain color i-large icon-flask inline-block"
									style="margin-bottom: 15px;"></i>
								<div class="heading-block border-bottom-0" style="margin-bottom: 15px;">
									<!-- <span class="before-heading">Smartly Coded &amp; Maintained.</span> -->
									<h4>Luniva Care Lab</h4>
								</div>
								<p class="text-left">Medecins du Monde Jane Addams reduce child mortality challenges
									Ford Foundation.
							...
							<div class="col-lg-4">
								<i class="i-plain color i-large icon-screen inline-block"
									style="margin-bottom: 15px;"></i>
								<div class="heading-block border-bottom-0" style="margin-bottom: 15px;">
									<!-- <span class="before-heading">Flexible &amp; Customizable.</span> -->
									<h4>Luniva Telmed</h4>
								</div>
								<p class="text-left">Democracy inspire breakthroughs, Rosa Parks; inspiration raise
									awareness natural
				...
				<div class="container clearfix">
					...
					<div class="heading-block topmargin-lg center">
						<h2>Lunivacare mHealth</h2>
						<span class="mx-auto">Luniva mHealth delivers health care through mobile apps.</span>
					</div>
					...
					<div class="row col-mb-50 mb-4">
						...
						<div class="col-lg-4 d-md-none d-lg-block text-center">
							<img src="images/luniva/and2.png" alt="phone">
						</div>
				...
				<div class="row clearfix align-items-stretch bottommargin-lg">
					...
					<div class="col-lg-6 center col-padding"
						style="background: url('images/luniva/dev.jpg') center center no-repeat; background-size: cover;">
					</div>
					...
					<div class="col-lg-6 center col-padding" style="background-color: #F5F5F5;">
						...
						<div class="center bottommargin">
							<a class="d-block position-relative" href="https://www.youtube.com/watch?v=6WS-PBJQIKM"
				...
				<div class="container clearfix">
					...
					<div class="row align-items-center col-mb-50">
						<div class="col-md-4 center">
							<img data-animate="fadeInLeft" src="images/luniva/and2.png" alt="Iphone">
						</div>
				...
				<div class="section parallax dark mb-0"
					style="background-image: url('images/luniva/testi.png'); padding: 100px 0; background-size: cover;">
							...
							<div class="slider-wrap">
								<div class="slide">
									...
									<div class="testi-content">
										<p>Connect to Grow, a UK DFID-funded programme, has worked with LunivaTech since
											the start of 2017. During this time, we have witnessed an excellent, young,
											social enterprise, working to address some of the big challenges faced in
											healthcare in Nepal. Connect has helped LunivaTech form an exciting
											partnership with LiveHealth in India, which could further modernize the way
											in which health data is managed and used in Nepal. We wish LunivaTech every
											success in their venture.</p>
								...
								<div class="slide">
									<div class="testi-image">
										<a href="#"><img src="images/luniva/Elodiejpg.jpg"
												alt="Customer Testimonails"></a>
									</div>
									<div class="testi-content">
										<p>I have been working with Lunivatech for over 6 months for the design and
											start-up of their LunivaCare project, which aims to digitalise health
											information and make it accessible to health professionals as well as
											patients, via software, mobile apps and online/offline system.</p>
										<p>From the onset, I have been impressed by Lunivatech innovative and proactive
											approach and have great hope that Lunivatech will be able to make a lasting
											different to the health sector and health of the Nepalese people!”</p>
										<div class="testi-meta">
				...
				<div class="conatiner">
					<div class="container clearfix">
						...
						<div class="row">
							...
							<div class="owl-carousel image-carousel carousel-widget" data-margin="60" data-loop="true"
								data-nav="false" data-autoplay="4000" data-pagi="false" data-items-xs="2"
								data-items-sm="3" data-items-md="4" data-items-lg="4" data-items-xl="4">

								<div class="oc-item colla"><a href="#"><img src="images/luniva/kath.png"
											alt="Clients"></a>
								</div>
								<div class="oc-item colla"><a href="#"><img src="images/luniva/himal.jpg"
											alt="Clients"></a>
								</div>
								<div class="oc-item colla"><a href="#"><img src="images/luniva/newbus.jpg"
											alt="Clients"></a>
								</div>
								<div class="oc-item colla"><a href="#"><img src="images/luniva/bus3602.png"
											alt="Clients"></a>
								</div>
							</div>
					...
					<div class="container clearfix">
						...
						<div class="row">
							...
							<div id="oc-clients" class="owl-carousel image-carousel carousel-widget" data-margin="60"
								data-loop="true" data-nav="false" data-autoplay="5000" data-pagi="false"
								data-items-xs="2" data-items-sm="3" data-items-md="4" data-items-lg="5"
								data-items-xl="6">

								<div class="oc-item"><a href="#"><img src="images/luniva/sam2.png" alt="Clients"></a>
								</div>
								<div class="oc-item"><a href="#"><img src="images/luniva/cry2.png" alt="Clients"></a>
								</div>
								<div class="oc-item"><a href="#"><img src="images/luniva/nrl2.png" alt="Clients"></a>
								</div>
								<div class="oc-item"><a href="#"><img src="images/luniva/life2.png" alt="Clients"></a>
								</div>
								<div class="oc-item"><a href="#"><img src="images/luniva/man3.png" alt="Clients"></a>
								</div>
								<div class="oc-item"><a href="#"><img src="images/luniva/gov logo.jpg" alt="Clients"></a>
								</div>
							</div>
				...
				<div class="container">
					...
					<div class="row col-mb-30">
						...
						<div class="col-md-6 text-center text-md-left">
							Copyrights &copy; 2021 All Rights Reserved by Luniva Tech.<br>
						...
						<div class="col-md-6 text-center text-md-right">
							<div class="d-flex justify-content-center justify-content-md-end">
								<a href="https://www.facebook.com/Luniva360/" target="_blank"
									class="social-icon si-small si-borderless si-facebook">
									<i class="icon-facebook"></i>
									<i class="icon-facebook"></i>
								</a>

								<a href="https://twitter.com/lunivatech" target="_blank"
									class="social-icon si-small si-borderless si-twitter">
									<i class="icon-twitter"></i>
									<i class="icon-twitter"></i>
								</a>

								<a href="https://www.linkedin.com/company/lunivatech-pvt-ltd-" target="_blank"
							...
							<i class="icon-envelope2"></i> lunivatech.nepal@gmail.com <span
								class="middot">&middot;</span>
							<i class="icon-headphones"></i> 01-5909085 <span class="middot">&middot;</span>
						</div>
